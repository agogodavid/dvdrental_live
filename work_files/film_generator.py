...
Reads source details from separate .txt files for easy expansion
"""
...
# Film templates organized by category
FILM_TEMPLATES = {
    "Action": {
        "titles": [
...
class FilmGenerator:
    ...
    def add_film_batch(self, num_films: int, category_focus: str = None, 
                      description: str = "", release_date: date = None) -> int:
        """
        Add new films to the database with inventory copies and track releases
        ...
        try:
            ...
            for _ in range(num_films):
                ...
                # Record film release (no staff ID for releases)
